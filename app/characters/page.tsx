...
export default function CharacterCreatorPage() {
  ...
  </div><footer className="mt-6 flex items-center justify-between gap-4"><button type="button" onClick={() => router.push("/perfil")} className="creator-navigation-button creator-navigation-button--back">‹ VOLTAR</button><p className="hidden text-center text-[10px] font-black uppercase tracking-[.16em] text-[#694b2b] sm:block">Escolhas atualizadas na prévia</p><button type="button" onClick={() => router.push("/perfil")} className="creator-navigation-button creator-navigation-button--continue">CONTINUAR ›</button></footer></main></div>;
}
