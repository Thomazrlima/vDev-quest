...
export function BrandLogo({ href, className = "", imageClassName = "", priority = false, size = 512 }: BrandLogoProps) {
  const image = <Image src="/quest-logo-new.png" alt="v(dev) Quest" width={size} height={size} priority={priority} className={`object-contain [image-rendering:pixelated] ${imageClassName}`} />;
