...
function RankingPage() {
    return (
        <main className="overflow-x-hidden bg-(--color-black)">
            <section className="relative min-h-185 overflow-hidden border-b-8 border-(--color-black) bg-(--color-black) bg-[url('/images/backgrounds/hall.png')] bg-cover bg-position-[center_46%] px-4 pt-7.5 shadow-[inset_0_-20px_48px_var(--color-black-overlay),inset_0_8px_28px_var(--color-black-overlay)] max-[760px]:min-h-152.5 max-[760px]:bg-position-[center_top] max-[760px]:bg-size-[auto_100%] max-[760px]:px-1.5">
                ...
                <header className="relative z-5 mx-auto grid aspect-2172/724 w-[min(840px,calc(100%-32px))] place-items-center text-center max-[760px]:w-[min(100%,calc(100%-14px))]">
                    ...
                    <div className="relative z-1 w-[min(76%,560px)] translate-y-[-8%] p-[3%_2%_2%] uppercase max-[760px]:w-[80%] max-[760px]:translate-y-[-5%] max-[760px]:pt-[4%]">
                        <p className="text-[.7rem] font-black tracking-[.26em] text-[#212638] max-[760px]:text-[.54rem]">{renderTextWithNumericFont("Ranking de Aventureiros · Temporada 2026")}</p>
                        <h1 id="ranking-title" className="my-1 text-[clamp(1.65rem,4.6vw,2.9rem)] font-black leading-[1.1] tracking-[.08em] text-[#212638] [-webkit-text-stroke:1px_#ffd45a] [paint-order:stroke_fill] [text-shadow:2px_2px_0_#b88620] max-[760px]:mx-auto max-[760px]:max-w-72.5 max-[760px]:text-[clamp(1.05rem,5vw,1.3rem)] max-[760px]:leading-[1.35]">
                            Hall da Fama
                        </h1>
                        <span className="text-[.78rem] font-bold tracking-[.12em] text-[#212638] max-[760px]:text-[.58rem]">Os maiores heróis, as maiores lendas</span>
                    </div>
                </header>
